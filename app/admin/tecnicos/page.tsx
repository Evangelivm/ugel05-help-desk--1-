    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold tracking-tight">Gestión de Técnicos</h2>
            <p className="text-muted-foreground">Administre el equipo de soporte técnico y sus asignaciones.</p>
          </div>
          ...
          <TabsContent value="list" className="space-y-4">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Gestione los técnicos, sus especialidades y disponibilidad.</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="performance" className="space-y-4">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Análisis de rendimiento y productividad del equipo técnico.</CardDescription>
              </CardHeader>
              <CardContent>
