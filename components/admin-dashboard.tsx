    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Bienvenido al panel de administración de la Mesa de Ayuda Virtual.</p>
        </div>
      ...
      <Tabs defaultValue="recent" className="space-y-4">
        <div className="flex justify-between">
          ...
          <Button className="bg-red-600 hover:bg-red-700 text-white">Gestionar Solicitudes</Button>
        </div>
        ...
        <TabsContent value="recent" className="space-y-4">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Se muestran las 10 solicitudes más recientes que requieren atención.</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="technicians" className="space-y-4">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Estado actual y carga de trabajo de los técnicos de soporte.</CardDescription>
            </CardHeader>
            <CardContent>
              <AdminTechnicians />
            </CardContent>
